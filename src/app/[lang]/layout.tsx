...
import { getMessages, createT, SupportedLocale } from "@/i18n";
...
export async function generateMetadata({ params }: { params: { lang: SupportedLocale } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `${url}/${params.lang}`, languages: { "en-US": `${url}/en-US`, "zh-CN": `${url}/zh-CN` } },
    openGraph: {
      type: "website",
      locale: params.lang,
      url: `${url}/${params.lang}`,
...
export default function RootLayout({ children, params: { lang } }: { children: React.ReactNode; params: { lang: SupportedLocale } }) {
